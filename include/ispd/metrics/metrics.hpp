...
public:
  ...
  ///
  /// This function plays a crucial role in the reporting mechanism of the
  /// simulation engine. Its primary responsibility is to write the aggregated
  /// global-level metrics, obtained during the simulation, to a specified file
  /// in the JSON format. The generated report serves as an essential input for
  /// the `ispd-exa-gui` application, enhancing the visualization and analysis
  /// of simulation results.
  ///
  /// \param reportFilePath The file path where the aggregated metrics report
...
/// Pointer to the global instance of the JSON object responsible for tracking
/// node-level metrics that will be written into the node-level metrics report
/// file.
...
///
/// This function serves the purpose of updating the aggregated node-level
/// report metrics with the metrics obtained from a specific machine.
///
/// \param metrics The machine metrics to be incorporated into the aggregated
/// report. \param configuration The machine configuration used for calculating
/// additional metrics. \param gid The global identifier of the machine for
/// uniquely identifying and associating metrics.
void notifyReport(
    const ispd::metrics::MachineMetrics &metrics,
...
///
/// This function serves the purpose of updating the aggregated node-level
/// report metrics with the metrics obtained from a specific link.
///
/// \param metrics The link metrics to be incorporated into the aggregated
/// report. \param configuration The link configuration used for calculating
/// additional metrics. \param gid The global identifier of the link for
/// uniquely identifying and associating metrics.
...
///
/// This function serves the purpose of updating the aggregated node-level
/// report metrics with the metrics obtained from a specific master.
///
/// \param metrics The master metrics to be incorporated into the aggregated
/// report. \param gid The global identifier of the master for uniquely
/// identifying and associating metrics.
...
///
/// This function serves the purpose of updating the aggregated node-level
/// report metrics with the metrics obtained from a specific switch.
///
/// \param metrics The switch metrics to be incorporated into the aggregated
/// report. \param configuration The switch configuration used for calculating
/// additional metrics. \param gid The global identifier of the switch for
/// uniquely identifying and associating metrics.
...
/// This function plays a crucial role in the reporting mechanism of the
/// simulation engine. Its primary responsibility is to write the aggregated
/// node-level metrics, obtained during the simulation, to a specified file in
/// the JSON format.
...
///
/// This method will remove all the necessary previously generated old
/// node-level aggregated report files. This is done to prevent the global-level
/// aggretation to use old metrics generated by previous simulations.
///
/// It must be noted that, although it there can be 64 node-level aggregated
/// report files, if the current simulation is using only 16 nodes, then only
/// the 16 node-level aggreated report files will be removed.
///
/// On the other hand, if a previous simulation only used 24 nodes, and the
/// current one is using 64 nodes, then all the previously node-level aggreated
/// report files will be removed.
...
/// This function plays a crucial role in the reporting mechanism of the
/// simulation engine. Its primary responsibility is to write the aggregated
/// global-level metrics, obtained during the simulation, to a specified file in
/// the JSON format. The generated report serves as an essential input for the
/// `ispd-exa-gui` application, enhancing the visualization and analysis of
/// simulation results.
///
/// \param reportFilePath The file path where the aggregated metrics report will
